  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button as="div">
          {button || (
            <div className="flex items-center focus:outline-none px-2 py-1">
              <Ink.Primary>
      ...
      >
        <Menu.Items
          className={classNames(
            ...
            'z-[31] absolute mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none',
            dropdownClasses,
          )}
        >
  ...
  <Menu.Item>
    {({ active }) => (
      <a
        onClick={onClick}
        className={classNames(
          'block px-4 py-2 text-sm text-gray-800 dark:text-gray-100',
